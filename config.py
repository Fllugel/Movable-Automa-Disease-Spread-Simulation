class Config:
    def __init__(self, polygon_points=None, cell_count=1500, infected_count=1, latent_prob=0.0, iterations_per_day=3,
                 infection_probability=0.25, infection_radius=10, infection_period=225,
                 latent_to_active_prob=0, infection_prob_latent=0.0, infection_prob_healthy=0.1,
